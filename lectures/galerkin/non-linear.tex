...
\begin{exercises}
\ex Prove that there exist solutions to the $p$-Laplace equation with Dirichlet boundary conditions and piece-wise linear basis functions. 

\ex Implement the problem numerically, selecting a suitable solver for the non-linear system. You may use existing libraries.
\end{exercises}
